...
class MultilingualString(BaseModel):
    ...
    direction: Optional[StrictStr] = Field(default='ltr', alias="@direction")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["@value", "@language", "@direction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "@direction": obj.get("@direction") if obj.get("@direction") is not None else 'ltr'
        })
