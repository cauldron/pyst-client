...
class Notation(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral', alias="@type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@value": obj.get("@value"),
            "@type": obj.get("@type") if obj.get("@type") is not None else 'http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral'
        })
